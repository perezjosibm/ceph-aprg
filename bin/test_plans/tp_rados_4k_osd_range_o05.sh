...
# use a NUMA socket for OSD and FIO, respectively, to minimize cross-socket traffic and get more stable results.
...
export RUNTIME=240 # (4 min) -- response curves
...
test_row['osd']="1"
test_row['reactor_range']="1,4" # Number of reactors, can be a ','-sep range
...
test_row['fio_numjobs']="1" # Number of threads per job, can be a ','-sep range, was 10
...
test_row['classic_cpu_set']="${VSTART_CPU_CORES}" #"0-1"
#test_row['fio_workload']="-j -a -r"
string=$(declare -p test_row)
test_table["1"]=${string}

test_row['osd']="2"
test_row['reactor_range']="1,4"
test_row['store_devs']='/dev/nvme8n1p2,/dev/nvme9n1p2'
test_row['vstart_cpu_set']="${VSTART_CPU_CORES}"
test_row['pool_type']="rados"
test_row['pool_size']="1024"
test_row['fio_type']="custom"
...
test_row['fio_blocksize']="4k"
test_row['fio_iodepth']="1,2,4,8,16,32,64,128"
test_row['classic_cpu_set']="${VSTART_CPU_CORES}"
string=$(declare -p test_row)
test_table["2"]=${string}

test_row['osd']="4"
test_row['reactor_range']="1,4"
test_row['store_devs']='/dev/nvme6n1p2,/dev/nvme7n1p2,/dev/nvme8n1p2,/dev/nvme9n1p2'
test_row['vstart_cpu_set']="${VSTART_CPU_CORES}"
test_row['pool_type']="rados"
test_row['pool_size']="1024"
test_row['fio_type']="custom"
