...
RBD_NAME=fio_test_0 RBD_SIZE="10G" fio ${FIO_JOBS}rbd_prefill.fio && rbd du fio_test_0 && /root/bin/run_fio.sh -s -a -c "0-5" -p crimson_1osd_4reactor_2ac_manual -k # w/o osd dump_metrics
...
RBD_NAME=fio_test_0 RBD_SIZE="10G" fio ${FIO_JOBS}rbd_prefill.fio && rbd du fio_test_0 && /root/bin/run_fio.sh -s -a -c "0-3" -p crimson_3osd_1reactor_1ac_manual -k # w/o osd dump_metrics
...
RBD_NAME=fio_test_0 RBD_SIZE="10G" fio ${FIO_JOBS}rbd_prefill.fio && rbd du fio_test_0 && /root/bin/run_fio.sh -s -a -c "0-8" -p crimson_3osd_2reactor_2ac_manual -k # w/o osd dump_metrics
...
RBD_NAME=fio_test_0 RBD_SIZE="10G" fio ${FIO_JOBS}rbd_prefill.fio && rbd du fio_test_0 && /root/bin/run_fio.sh -s -a -c "0-13" -p crimson_3osd_4reactor_2ac_manual -k # w/o osd dump_metrics
...
RBD_NAME=fio_test_0 RBD_SIZE="10G" fio ${FIO_JOBS}rbd_prefill.fio && rbd du fio_test_0 && /root/bin/run_fio.sh -s -a -c "0-31" -p crimson_3osd_8reactor_2ac_manual -k # w/o osd dump_metrics
